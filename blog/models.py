...
class PostQuerySet(models.QuerySet):
    ...
    def fetch_with_comments_count(self):
        ...
        posts_with_comments = Post.objects.filter(id__in=posts_ids).annotate(comments_count=Count('post_commented'))
    ...
    def get_prefetch_data_for_posts(self):
        ...
        prefetch = self.prefetch_related(Prefetch('tags', Tag.objects.get_count_posts_for_tag()))
...
class Comment(models.Model):
    post = models.ForeignKey("Post", on_delete=models.CASCADE, related_name='post_commented', verbose_name="Пост, к которому написан")
